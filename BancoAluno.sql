...
(
    ...
    CONSTRAINT [FK_StudentCourse_Course_CourseId] FOREIGN KEY ([CoursoId]) REFERENCES [Curso] ([Id]),
    CONSTRAINT [FK_StudentCourse_Student_StudentId] FOREIGN KEY ([AlunoId]) REFERENCES [Aluno] ([Id])
);
GO